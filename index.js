...
module.exports = class extends Page {
    constructor(){
        super({title:"Home", sName:"Abhishek Sawant"});
    }
    render(sPage) {
        const oJson = fetch("https://pwapopupmeal-default-rtdb.firebaseio.com/meals.json").json();
        console.log(oJson);
        ...
        Object.keys(oJson).map((key) => {
            ...
            <form action="https://chatbot-meal.herokuapp.com/payment" method="post">
